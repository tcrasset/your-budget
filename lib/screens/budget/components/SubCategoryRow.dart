...
class _SubcategoryRowController extends State<SubcategoryRow> {
  ...
  handleSubcategoryNameChange(String value) {
    print("Changed name of subcategory from ${widget.subcat.name} to ${_nameController.text} ");
    if (value != widget.subcat.name) {
      setState(() {
        widget.subcat.name = value;
      });
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            ...
            onFieldSubmitted: (String value) => state.handleSubcategoryNameChange(value),
          )),
          Expanded(
            child: TextFormField(
                decoration: new InputDecoration.collapsed(
