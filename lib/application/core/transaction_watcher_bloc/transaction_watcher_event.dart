...
class TransactionWatcherEvent with _$TransactionWatcherEvent {
  ...
  const factory TransactionWatcherEvent.selectTransaction(
      {required String id}) = _TransactionSelected;
  const factory TransactionWatcherEvent.deleteSelectedTransactions() =
