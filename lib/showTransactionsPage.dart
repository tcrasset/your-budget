...
class ShowTransactionPageState extends State<ShowTransactionPage> {
  ...
  Container _buildTransactionContainer(AsyncSnapshot snapshot, int index) {
    ...
    SubCategory subcategory = subcategories
          .singleWhere((subcategory) => subcategory.id == moneyTransaction.subcatID,
                        orElse: () => null);
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: <Widget>[
              Expanded(child: Text("MyMemo", textAlign: TextAlign.left,),),
              Text("${moneyTransaction.amount} €", textAlign: TextAlign.right),
            ],
          ),
          Row(
            children: <Widget>[
              Text(subcategoryName, textAlign: TextAlign.left,),
