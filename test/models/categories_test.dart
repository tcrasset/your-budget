...
void main() {
  group('SubCategory', () {
    test(
        'SubCategory.blank() returns SubCategory instance copy with zero money budgeted',
        () {
    ...
    test(
        ...
        () {
      final SubCategory newSub = SubCategory(
          id: 3, parentId: 1, name: "Same", budgeted: 66.52, available: 78.8);
      final SubCategory newSubCopy = SubCategory(
          id: 3, parentId: 1, name: "Same", budgeted: 66.52, available: 78.8);
      final SubCategory otherSub = SubCategory(
          id: 3,
          parentId: 1,
          name: "NotTheSame",
          budgeted: 66.52,
    ...
    test(
        'SubCategory.update() returns an updated version of SubCategory instance',
        () {
      final SubCategory subcatTest = SubCategory(
          id: 3, parentId: 1, name: "Test", budgeted: 66.52, available: 78.8);
      final SubCategory changedSubcat = SubCategory(
          id: 3, parentId: 1, name: "Passed", budgeted: 70.52, available: 68.8);
  ...
  group('MainCategory', () {
    ...
    test(
        'MainCategory.addMultipleSubcategories() adds multiple subcategories and updates values',
        () {
      final MainCategory catTest = MainCategory(id: 1, name: "Test");
      final SubCategory newSub1 = SubCategory(
          id: 1, parentId: 1, name: "Test", budgeted: 60, available: 70);
      final SubCategory newSub2 = SubCategory(
          id: 2, parentId: 1, name: "Test", budgeted: 50, available: 70);
    ...
    test(
        'MainCategory.removeSubcategory() removes a subcategory and updates values',
        () {
      final MainCategory catTest = MainCategory(id: 1, name: "Test");
      final SubCategory newSub = SubCategory(
          id: 3, parentId: 1, name: "Test", budgeted: 66.52, available: 78.8);
